...
\begin{equation}
    ...
    \end{aligned}
\end{equation}
where E is the binding energy, the same definition for proton separation energy.
When the separation energy is positive, the nucleus is bounded, otherwise unstable.
...
\begin{figure}
    ...
    \caption{Theoretical and Experimental two-nucleon separation energies of
...
The invariance of binding energy per nucleon ($E_b/A$) w.r.t. A means that
...
is approximately constant. A more strict definition of the saturation density
...
constant interior baryon density. For heavy nuclei, charge density of those
