...
The maxium beam current of $200\ \mu A$ available at CEBAF is limited by the 
rf power ($1\ MW = 5\ GeV \times 200\ \mu A$) and by the beam power on the 
beam dump. While Hall B and D requires only tiny amount of cw beams (at $nA$ level),
it is actually Hall A and C that consume the $200 \ \mu A$ electron beams, both
can receive a few tenths to over one hundred $\mu A$.
...
halls (A, B and C) for various experiments. Because all 4 halls share the same 
electron gun, PVES experiment has priority over other experiments to maintain 
the quality of polarized electron beam.
