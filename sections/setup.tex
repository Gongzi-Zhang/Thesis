...
\begin{figure}[!h]
    ...
    {Evolution of PVES experiments, solid lines represent the relative 
    ...
    and MOLLER experiment \cite{Moller-project} at JLab, P2 experiment on the future
    ...
    (MESA-12C is the same experiment as MESA-P2 with a different \Carbon target) }
\end{figure}
...
other low frequency noises. As for the first method, it is best in terms of % FIXME e.g. of other low frequency noises
...
\begin{figure}[!h]
    ...
    {Aerial view of JLab accelerator site, yellow line tells the position
...
detector), attached to a lightguide. the Cherenkov light radiated by electrons	% FIXME reference for Cherenkov
...
One problem that failed PREX-I is the excessive radiation, which damages
...
On both sides of the beamline collimator are the 5~mm thick stainless steel
...
Data acquisition works in 2 modes: the integrating mode and the counting mode,
...
The helicity signal sent to injector components (PCs, IAs and the double wien filters) 
