...
% The nature of being PV means measurement of different polarization states, 
% while the \textbf{tiny} characteristic of PV asymmetry demands fast flipping of the polarization states.
...
% means it is out of the capacity of storage ring accelerators and 
...
$T_{settle}$ time to allow settlement of the high voltage in PCs % $0\ \mu s$
