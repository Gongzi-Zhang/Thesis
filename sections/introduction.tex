...
The Lead Radius EXperiment-II (PREX-II) and Calcium Radius EXperiment (CREX) are 
...
identified ($R_0 \approx 1.20\ \mathrm{fm}$). But this simple picture becomes powerless
...
measurement, which is also tiny, many efforts are needed to do such measurements.
...
the hadronic probe includes pion \cite{ALLARDYCE19731}, proton \cite{LOMBARDI1972103,PhysRevC.82.044611}, 
...
Experimentally, with model dependence, the best resolution we got about $R_n$ is better than 1\%,
...
$\rho(r) = \frac{\rho(0)}{2}$, 
and $t \sim 0.4-0.5 \ fm$ for  $A > 40$ indicates the surface thickness, over
which $\rho{r}$ falls from 90\% to 10\% .
\begin{figure}
    \centering
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% nuclei models:
% 1. Liquid Drop Model -- macroscopic
% 2. Fermi Gas Model -- microscopic
% 3. Nuclear Shell Model -- micro
