...
highly longitudinally polarized electron beam, which was provided by the Continuous Electron Beam Accelerator
Facility (CEBAF) at Thomas Jefferson National Accelerator Facility (TJNAF, 
also known as JLab). The excellent beam qualities and dedicated instrumentation
...
Well, we don't have a complete and thorough understanding of nuclei. In a 
simple picture, of course, one may estimate the nuclear radius as $R = cA^{1/3}$, 
where $A$ is the nuclear mass number 
and $c$ is an approximative constant coefficient that can be experimentally 
identified ($\sim 1.20\ fm$ \cite{FIXME}). But this simple picture becomes powerless
...
Physicists have calculated and precisely measured the proton radius of many nuclei,
...
precise determination of the neutron radius ($R_n$). The difficulties lie in that
...
interaction) to measure it directly, therefore people turn to PV asymmetry
measurement, which is also tiny, and much effort is needed during experiments;
...
hadronic measurement is usually model dependent. Though of these
difficulties, there has been a lot of effort from the community to explore the
...
to cover the whole space of $\vec{q}$ experimentally, therefore, some phenomenological
...
% Experimental hints of the existence of the neutron skin comes from optical isotope
% shifts (FIXME)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}    
    ...
    \end{tikzpicture}
    \caption{Schematic plot of eA scattering. As we can see, the virtual photon 
...
% why it is important
% how to know/measure it -- theoretically and experimentally
...
\end{equation}
where $C_{iq}$ are coefficient constants predicted by the SM. 
\begin{equation}
    \begin{gathered}
	C{1q} \equiv 2g_A^e g_V^q	\qquad C_{2q} \equiv 2g_V^e g_A^q
